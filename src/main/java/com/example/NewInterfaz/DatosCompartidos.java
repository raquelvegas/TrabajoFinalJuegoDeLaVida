...
public class DatosCompartidos {
    ...
    private static String aparicionInicial = "0";  // Controlador general de la aparición de elementos
    ...
    private static int anadir = 0;  // No se guarda en el Json
    private static boolean anadirTab = false;  // No se guarda en el Json
    private static boolean contenidoCeldaTab = false;  // No se guarda en el Json
    private static int numIndividuos = 0;
    private static int turnoJuego = 0;
    private static double velocidadJuego = 1;  // No se guarda en el Json
